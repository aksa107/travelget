...
<h2 class="mb-4 mt-5">Enquires List</h2>
...
?>
 ...
 <div class="col col-2" name="Amount"><?php echo $message ?></div>
 <div class="col col-2" name="cancel"><button class="btn btn-danger"><a href="deletereq.php?name=<?php echo $id;?>" class="text-white ">Delete</a></button></div>
 </li>
